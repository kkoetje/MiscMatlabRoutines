function [cout,hout] = trisurfc(xin,yin,zin,N)
...
%
% Contour line code by Darren Engwirda - 2005 (d_engwirda@hotmail.com)
% Updated 15/05/2006
% Modified for trisurfc by JK September 2009
% Surface code added by Jack Kohoutek - 2009 (jack.kohoutek@gmail.com
...
Hn=zin;
trisurf(t,xin,yin,zin);
zlimits = get(gca,'Zlim');
contourplotheight=zlimits(1);
hold on
...
for v = 1:num       % Loop over contouring levels
    ...
    if nargout>0
        ...
        patch('Xdata',[penew(c1,1),penew(c2,1)]', ...
              ...
              'Zdata',z2,'Cdata',z,'facecolor','none','edgecolor','flat');  
        hold on
